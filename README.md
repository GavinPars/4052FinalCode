...
File  
ProjectCode.R: main analysis script containing all data cleaning, Box-Cox transformation, train/test split, and three regression models (MLR, PCR, Random Forest)
...
Usage  
Run ProjectCode.R top to bottom with set.seed(42) already set for reproducibility.
